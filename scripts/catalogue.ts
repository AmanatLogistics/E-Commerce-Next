 ...
 * Pakistani gem deposits (see docs/RESEARCH.md): Swat emerald, Hunza ruby and spinel,
 * Skardu and Shigar aquamarine and tourmaline, Katlang pink topaz, Kohistan peridot.
 ...
 *
 * Prices are whole rupees here and converted to paisa by the seed script.
...
export const CATEGORIES: SeedCategory[] = [
  {
    ...
    name: "Emerald",
    description:
      "Beryl coloured green by chromium. Pakistan's emeralds come mainly from the talc schists above Mingora in the Swat valley, worked since the deposit was found in 1958.",
    sortOrder: 1,
  },
  {
    slug: "ruby",
    name: "Ruby",
    description:
      "Red corundum. The Hunza valley produces gem corundum in marble beds, typically in smaller sizes with a distinctive pinkish red.",
    sortOrder: 2,
  },
  {
    slug: "spinel",
    name: "Spinel",
    description:
      "Long mistaken for ruby, now collected in its own right. Hunza marbles yield clean pink and red spinel that is almost always untreated.",
    sortOrder: 3,
  },
  {
    slug: "aquamarine",
    name: "Aquamarine",
    description:
      "Blue beryl from the pegmatites around Dassu, Shigar and Skardu in Gilgit-Baltistan — among the finest documented material anywhere.",
    sortOrder: 4,
  },
  {
    slug: "topaz",
    name: "Topaz",
    description:
      "The Katlang mine near Mardan is known worldwide for baby-pink and purplish-pink topaz, a colour found in very few other places.",
    sortOrder: 5,
  },
  {
    slug: "tourmaline",
    name: "Tourmaline",
    description:
      "Pegmatite tourmaline from Gilgit, Shigar and Stak Nala, in greens, pinks and bicolour combinations.",
    sortOrder: 6,
  },
  {
    slug: "peridot",
    name: "Peridot",
    description:
      "Gem olivine from the Sapat area of Kohistan, at altitude — known for large, clean crystals with a strong green.",
    sortOrder: 7,
  },
];
...
export const GEMS: SeedGem[] = [
  ...
  },
  {
    ...
    featured: true,
    description:
      "An uncut hexagonal crystal still seated in its talc schist matrix, which is the rock type the Swat emeralds form in. Collected as a mineral specimen rather than as cutting rough — the termination is intact and the crystal has not been trimmed.",
  },

  // ---------------- Ruby ----------------
  {
    slug: "hunza-ruby-oval-1-32ct",
    reference: "KG-RB-0201",
    ...
    clarity: "Slightly included",
    dims: [7.05, 5.30, 3.85],
    origin: "Hunza Valley, Gilgit-Baltistan, Pakistan",
    ...
    featured: true,
    description:
      "Unheated Hunza ruby with the pinkish red the marble-hosted deposits are known for. Untreated corundum of this size is uncommon from this source; the colour is entirely natural and there is no evidence of heat.",
  },
  {
    slug: "hunza-ruby-round-0-61ct",
    reference: "KG-RB-0202",
  ...
  // ---------------- Aquamarine ----------------
  {
    ...
    origin: "Shigar Valley, Gilgit-Baltistan, Pakistan",
    treatment: "None (unheated)",
    certificate: "Independent lab report available on request",
    price: null,
    status: "available",
  ...
  },
  {
    ...
    origin: "Dassu, near Skardu, Pakistan",
    treatment: "None (unheated)",
    certificate: "",
    price: 128000,
    status: "available",
  ...
  // ---------------- Topaz ----------------
  {
    ...
    reference: "KG-TZ-0501",
    title: "Katlang Pink Topaz, Oval, 3.42 ct",
    category: "topaz",
    carat: 3.42,
    shape: "Oval",
    cut: "Brilliant",
    colour: "Baby pink with a slight purple secondary",
    clarity: "Eye clean",
    dims: [10.20, 8.05, 5.60],
    origin: "Katlang, Mardan, Pakistan",
    treatment: "None (untreated)",
    certificate: "Independent lab report available on request",
    price: null,
    status: "available",
    featured: true,
    description:
      "Natural pink topaz from Katlang, the deposit that made this colour known. The pink is entirely natural — no irradiation and no heat, which matters because a great deal of pink topaz on the market is treated. Eye clean with a soft, even colour.",
  },
  {
    slug: "katlang-pink-topaz-cushion-1-96ct",
    reference: "KG-TZ-0502",
    ...
    featured: false,
    description:
      "A paler pink than the larger oval, and correspondingly gentler in a setting. Untreated, clean, and cut with a small culet that keeps the stone lively at this tone.",
  },
  {
    slug: "katlang-topaz-crystal-22ct",
    reference: "KG-TZ-0503",
    title: "Pink Topaz Crystal, 22.00 ct",
    category: "topaz",
    carat: 22,
    shape: "Natural prism",
    cut: "Uncut crystal",
    colour: "Pink, colour zoned",
    ...
    featured: false,
    description:
      "An uncut crystal showing clear colour zoning from near-colourless at the base to pink at the termination, which is how the colour actually occurs in this deposit. Kept whole as a specimen.",
  },

  // ---------------- Tourmaline ----------------
  {
    slug: "stak-nala-bicolour-tourmaline-5-12ct",
    reference: "KG-TM-0601",
    ...
    origin: "Stak Nala, Gilgit-Baltistan, Pakistan",
    treatment: "None (untreated)",
    certificate: "",
    price: 92000,
    status: "available",
  ...
  // ---------------- Peridot ----------------
  {
    ...
    origin: "Sapat, Kohistan, Pakistan",
    treatment: "None (untreated)",
    certificate: "Independent lab report available on request",
    price: null,
    status: "available",
    featured: true,
    description:
      "Kohistan peridot is mined at high altitude and is known for producing large, clean crystals with a stronger green than most other sources. This is a substantial stone, eye clean, with the vivid colour the deposit is sought out for. Peridot is never treated.",
  },
  {
    slug: "sapat-peridot-cushion-4-70ct",
    reference: "KG-PD-0702",
  ...
  },
  {
    ...
    featured: false,
    description:
      "A straightforward, well-cut round. Bright, clean and an easy entry point into gem-quality Pakistani peridot.",
  },
];
